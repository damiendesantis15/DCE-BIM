...
namespace DCEabout
{
    ...
    public class DCEBIM360Pro : IExternalCommand
    {
        ...
        public Autodesk.Revit.UI.Result Execute(Autodesk.Revit.UI.ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            string uri = "https://dcestructural.sharepoint.com/:b:/r/bim/BIM/DCE%20BIM360%20Access%20and%20Procedures.pdf?csf=1&web=1&e=Wgw0bJ";
            System.Diagnostics.Process.Start(uri);

            string commandName = "DCEBIM360Pro";
